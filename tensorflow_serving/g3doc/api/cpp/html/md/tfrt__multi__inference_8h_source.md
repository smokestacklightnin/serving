...
TENSORFLOW\_SERVING\_SERVABLES\_TENSORFLOW\_TFRT\_MULTI\_INFERENCE\_H\_]{.preprocessor}
:::
...
::: {.line}
[]{#l00028}[ 28]{.lineno} [// Implementation of MultiInference using the
tfrt::SavedModel.]{.comment}
:::

::: {.line}
[]{#l00029}[ 29]{.lineno} Status RunMultiInference([const]{.keyword}
tfrt::SavedModel::RunOptions& run\_options,
:::

::: {.line}
[]{#l00030}[ 30]{.lineno}  [const]{.keyword} absl::optional\<int64\_t\>&
servable\_version,
:::

::: {.line}
[]{#l00031}[ 31]{.lineno}  tfrt::SavedModel\* saved\_model,
:::
...
::: {.line}
[]{#l00033}[ 33]{.lineno}  MultiInferenceResponse\* response);
:::
...
TENSORFLOW\_SERVING\_SERVABLES\_TENSORFLOW\_TFRT\_MULTI\_INFERENCE\_H\_]{.comment}
:::
:::
:::
