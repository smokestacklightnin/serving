...
TENSORFLOW\_SERVING\_SESSION\_BUNDLE\_SAVED\_MODEL\_CONFIG\_H\_]{.preprocessor}
:::
...
::: {.line}
[]{#l00028}[ 28]{.lineno} Status
MaybeLoadSavedModelConfig([const]{.keyword} std::string& export\_dir,
:::

::: {.line}
[]{#l00029}[ 29]{.lineno}  SessionOptions\* session\_options);
:::
...
::: {.line}
[]{#l00031}[ 31]{.lineno} } [// namespace session\_bundle]{.comment}
:::
...
TENSORFLOW\_SERVING\_SESSION\_BUNDLE\_SAVED\_MODEL\_CONFIG\_H\_]{.comment}
:::
:::
:::
